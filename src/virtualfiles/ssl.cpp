...
pcapfs::Bytes pcapfs::SslFile::decryptData(uint64_t padding, size_t length, char *data, char *key, char* key_material) {
    ...
    switch (cipherSuite->getSymKeyAlg()) {
        ...
        case pcpp::SSL_SYM_RC4_64:
            ...
            return decrypt_RC4_64(padding, length, data, key);
        ...
        case pcpp::SSL_SYM_RC4_56:
            ...
            LOG_ERROR << "unsupported operation" << std::endl;
            return decrypt_RC4_56(padding, length, data, key);
 ...
 */
pcapfs::Bytes pcapfs::SslFile::decrypt_RC4_128(uint64_t padding, size_t length, char *data, char *key) {
...
pcapfs::Bytes pcapfs::SslFile::decrypt_RC4_56(uint64_t padding, size_t length, char *data, char *key) {
...
pcapfs::Bytes pcapfs::SslFile::decrypt_RC4_64(uint64_t padding, size_t length, char *data, char *key) {
