...
namespace pcapfs {
    ...
    public:
        ...
        void setSmbVersion(uint16_t dialect) { smbVersion = dialect; };
        uint16_t getSmbVersion () { return smbVersion; };
    ...
    private:
        ...
        std::string const parseSmbTraffic(const std::vector<Bytes> &smbData);

        uint16_t smbVersion = 0;
