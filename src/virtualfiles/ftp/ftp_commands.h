	...
	namespace ftp {
		class FtpCommands {
			public:
				...
				static const std::string MDTM; // Return the last-modified time of a specified file
				...
				static const std::string NLST; // Returns a list of file names in a specified directory
				...
				static const std::string STAT; // file status information
