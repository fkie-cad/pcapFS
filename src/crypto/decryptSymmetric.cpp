...
//TODO:
pcapfs::Bytes
pcapfs::Crypto::decrypt_AES_128_GCM(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                                    unsigned char *iv) {
    ...
    if (return_code != 1) {
        LOG_ERROR << "EVP_CIPHER_CTX_ctrl() returned a return code != 1, 1 means success. It returned: " << return_code
                  << std::endl;
    } else {
        LOG_DEBUG << "EVP_CIPHER_CTX_ctrl() returned: " << return_code << std::endl;
    }
...
//TODO:
pcapfs::Bytes
pcapfs::Crypto::decrypt_AES_256_GCM(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                                    unsigned char *iv) {
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_AES_128_CBC(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                                    unsigned char *iv) {
>>>>>>> origin/dev
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_AES_256_CBC(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                                    unsigned char *iv) {
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_RC4_128(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                                unsigned char *) {
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_RC4_40(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                               unsigned char *) {
...
*/
    ...
    if (return_code != 1) {
        LOG_ERROR << "EVP_CIPHER_CTX_set_key_length() returned a return code != 1, 1 means success. It returned: "
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_RC4_56(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                               unsigned char *) {
...
pcapfs::Bytes
pcapfs::Crypto::decrypt_RC4_64(uint64_t padding, size_t length, char *data, unsigned char *, unsigned char *key,
                               unsigned char *) {
...
pcapfs::Bytes pcapfs::Crypto::decryptRc4(uint64_t padding, size_t length, char *data, char *, char *key, char *) {
    ...
    LOG_DEBUG << "DECRYPTED RC4 DATA: " << decryptedContent << " KEY TO USE: " << keyToUse << " KEY: " << key
              << std::endl;
